...
| **Generatore WPS da WPQR (Mason)** | Pivot 30/07/2026: Tabella 5 15614 + `wpsGenerator` (P0) → endpoint/UI (P1) → deprecare ingest WPS come flusso primario (P2). Spec: [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) | 🟢 P0 CHIUSO (Tabella 5 + `wpsGenerator`); P1 endpoint/UI |
