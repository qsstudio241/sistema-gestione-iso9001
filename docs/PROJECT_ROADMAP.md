...
**Ultimo aggiornamento di questa sezione**: 16/08/2026 (SB-1 mergiata #440; ISO-3 deployata; MC-1 tabelle 149 su VPS, PR #450).
...
**Second Brain SB-1 mergiata** ([PR #440](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/440), 16/08): snapshot fatti Ambito (NC / qualifiche / documenti, zero LLM) in Assistente AI. Brief [`DEPUTYTASK2.md`](agent-tasks/DEPUTYTASK2.md) **CHIUSO**. Prossima: SB-2 (Ambito header = unico input). Non sovrascrivere [`DEPUTYTASK.md`](agent-tasks/DEPUTYTASK.md) (SAL S1a).
...
| 8 | **Second Brain — Assistente di Ambito (SB-2 Ambito header)** | SB-1 mergiata (#440). Prossima: card/GET seguono solo l'Ambito in header; patrimonio / «Tutto lo studio» → «Seleziona un'azienda» | [PLAN](agent-tasks/PLAN_SECOND_BRAIN_SLICES.md) · brief [SB-1 CHIUSO](agent-tasks/DEPUTYTASK2.md) |
