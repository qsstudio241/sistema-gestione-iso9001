...
**Ultimo aggiornamento di questa sezione**: 16/08/2026 (deploy ISO-3; MC-1 migrazione 149 in PR).
...
**MC-1 in corso (16/08)** — tabelle `material_certificates` + `material_certificate_checks` (mig. **149**). ISO-3 deployata sul VPS (health 200).
...
**ISO-3 mergiata + deploy (16/08)** — [PR #448](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/448): chiavi EN 10204/10168 + apporto nel prompt capitolato; persistenza mig. 116.
...
| 4 | **Material Compliance AI (certificati EN 10204, base e apporto)** | MC-0 mergiata (#447). MC-1 = mig. 149 (tabelle). Poi MC-2 seed KB. Tubi e soglie apporto: Markdown mancante → skip | [DATA_MODEL](specs/MATERIAL_COMPLIANCE_DATA_MODEL.md) · [MODULO](specs/MODULO_MATERIAL_COMPLIANCE_AI.md) · brief [MC-1](agent-tasks/DEPUTYTASK_MC1.md) |
