...
| **Pivot WPS — generazione da WPQR (non ingest)** | Feedback Mason 30/07/2026: matcher 15614 + bozza 15609 + Word Annex A. **P0–P3 ✅**. **P4 ✅** (04/08/2026): AskAi orchestra `generateWPS` in chat (`need_input` → domande → re-check). **P5 backlog**: riesame multi-giunto + visione advisory. | [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) |
