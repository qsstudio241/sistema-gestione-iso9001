...
**Ultimo aggiornamento di questa sezione**: 16/08/2026 (MC-0 spec chiuse: certificati **base e apporto**; mappa Second Brain [PLAN_SECOND_BRAIN_SLICES.md](agent-tasks/PLAN_SECOND_BRAIN_SLICES.md)).
...
**MC-0 spec chiuse (16/08)** — tre file [DATA_MODEL](specs/MATERIAL_COMPLIANCE_DATA_MODEL.md) / [UI](specs/MATERIAL_COMPLIANCE_UI.md) / [API](specs/MATERIAL_COMPLIANCE_API.md). Stesso elenco per lamiere e filo (`material_role`). Prossima slice MC: **MC-1** migration. ISO-3 (prompt capitolato, stesse chiavi incluso apporto) resta la prossima slice 3834.
...
| 4 | **Material Compliance AI (certificati EN 10204, base e apporto)** | MC-0 spec chiuse. Prossimo: MC-1 migration. Tubi e soglie apporto: Markdown mancante → skip | [DATA_MODEL](specs/MATERIAL_COMPLIANCE_DATA_MODEL.md) · [MODULO](specs/MODULO_MATERIAL_COMPLIANCE_AI.md) |
...
| **Material Compliance AI (certificati EN 10204, base e apporto)** | Modulo proposto 05/08/2026: PDF → estrazione AI → Rule Engine → HITL. **MC-0 chiusa 16/08** (DATA_MODEL/UI/API, `material_role`). **Prossimo:** MC-1 migration. Soglie lamiere EN 10025-2 in Markdown; tubi e soglie apporto ancora da consegnare (skip). | [sintesi](reference/MATERIAL-COMPLIANCE-NORME-SINTESI.md) · [MODULO](specs/MODULO_MATERIAL_COMPLIANCE_AI.md) · [PLAN](agent-tasks/PLAN_MATERIAL_COMPLIANCE_SLICES.md) · [brief MC-0](agent-tasks/DEPUTYTASK_MATERIAL_COMPLIANCE_AI_FOUNDATION.md) · ADR-020…024 |
