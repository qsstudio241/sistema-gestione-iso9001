...
| **Pivot WPS — generazione da WPQR (non ingest)** | Feedback Mason 30/07/2026: matcher 15614 + bozza 15609 + Word Annex A. **P0–P2b ✅** (#326/#328/#332 + P2b UI). **P3 ✅** (04/08/2026): `need_input` + `questions[]` se dati giunto incompleti. **P4/P5 backlog**: AI pone le domande; riesame multi-giunto + visione advisory. | [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) |
