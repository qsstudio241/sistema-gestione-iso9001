...
**Lead wayfinder — ISO 3834 HITL 16/08** (solo doc): chiuse 4 scelte prodotto nel [`PLAN_3834_SLICES.md`](agent-tasks/PLAN_3834_SLICES.md). ISO-2 = Word/tracciabilità senza blocco; ISO-4 = verbale Mason; livelli 2/3/4 = stessa UI; §11–13 = epic Material Compliance (scan + riuso ingest qualifiche/WPQR + OCR). Brief [`DEPUTYTASK1.md`](agent-tasks/DEPUTYTASK1.md) resta **ISO-1a** (RBAC RDP). Nessun codice applicativo.
