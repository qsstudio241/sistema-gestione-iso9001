...
> **Prossimo Step (post sessione 02/05)**: T3 smoke L3 ✅, T4 ✅, T5 ✅, allegati custom unificati ✅. Export Word checklist custom: hyperlink allegati (PDF/foto) allineato a ISO ✅ e smoke produzione upload → link + embed ✅ (02/05). Prossime sessioni: (1) P1 smoke L3 custom checklist (DEPUTYTASK pronto), (2) ISO 14001 checklist completa da norma PDF via deputy, (3) SYNC-5 allegati offline. SYNC-5 resta in backlog attivo.
