...
**Ultimo aggiornamento di questa sezione**: 16/08/2026 (ISO-2 riesame §5.3 in [PR #443](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/443); ISO-1* mergiata).
...
**ISO-2 — Riesame §5.3 data/utente + Word** ([PR #443](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/443)): timbro nel JSON, niente blocco apertura, Word checklist. Prossima: ISO-3 (AI capitolato). Brief [`DEPUTYTASK1.md`](agent-tasks/DEPUTYTASK1.md) **CHIUSO**.
...
| 7 | **ISO 3834 — completezza per processi (RBAC + ponti + report)** | ISO-1* mergiata. ISO-2 in PR #443. Dopo merge: ISO-3 AI capitolato; Word RDP Mason = ISO-4 | [PLAN](agent-tasks/PLAN_3834_SLICES.md) · brief [ISO-2 CHIUSO](agent-tasks/DEPUTYTASK1.md) |
