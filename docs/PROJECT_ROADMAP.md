...
| **Pivot WPS — generazione da WPQR (non ingest)** | Feedback Mason 30/07/2026: matcher 15614 + bozza 15609. **P0 ✅** (PR #326). **P1** API+UI+AskAi in [DEPUTYTASK1.md](agent-tasks/DEPUTYTASK1.md) (**APERTO**). Ingest WPQR resta centrale; ingest WPS → legacy (P2). | [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) |
...
- **Pivot WPS (30/07/2026)**: generazione WPS da WPQR (caso demo FW S355/S235). P0 ✅ · P1 brief [DEPUTYTASK1.md](agent-tasks/DEPUTYTASK1.md). Spec: [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md)
...
| **Generatore WPS da WPQR (Mason)** | Pivot 30/07/2026: Tabella 5 + `wpsGenerator` (**P0 ✅** #326) → endpoint/UI/AskAi (**P1**) → deprecare ingest WPS (P2). Spec: [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) | 🟡 P1 APERTO ([DEPUTYTASK1.md](agent-tasks/DEPUTYTASK1.md)) |
