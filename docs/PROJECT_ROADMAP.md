...
| **Pivot WPS — generazione da WPQR (non ingest)** | Feedback Mason 30/07/2026: matcher 15614 + bozza 15609. **P0 ✅** (#326) · **P1 ✅** API+UI+AskAi (#328, deploy VPS 30/07). Ingest WPQR resta centrale; ingest WPS → legacy (**P2**). | [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) |
...
- **Pivot WPS (30/07/2026)**: generazione WPS da WPQR (caso demo FW S355/S235). **P0+P1 ✅** (#326/#328). Spec: [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md). Prossimo: **P2** (deprecare upload WPS come flusso primario / export Word).
...
| **Generatore WPS da WPQR (Mason)** | Pivot 30/07/2026: Tabella 5 + `wpsGenerator` (**P0 ✅** #326) → endpoint/UI/AskAi (**P1 ✅** #328, VPS deployato) → deprecare ingest WPS (**P2**). Spec: [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) | ✅ P0+P1; P2 backlog |
