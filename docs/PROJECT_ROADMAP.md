...
**Ultimo aggiornamento di questa sezione**: 16/08/2026 (EN 10025-2 + ISO-2 [PR #443](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/443); mappa Second Brain [PLAN_SECOND_BRAIN_SLICES.md](agent-tasks/PLAN_SECOND_BRAIN_SLICES.md)).
...
| **Material Compliance AI (certificati EN 10204 3.1)** | Modulo proposto 05/08/2026: PDF → estrazione AI → Rule Engine → HITL. **Norme tipo/layout consegnate 16/08** (dizionario EN 10168). **Prossimo:** MC-0 spec DATA_MODEL/UI/API. Soglie grado ancora da consegnare. | [sintesi](reference/MATERIAL-COMPLIANCE-NORME-SINTESI.md) · [MODULO](specs/MODULO_MATERIAL_COMPLIANCE_AI.md) · [PLAN](agent-tasks/PLAN_MATERIAL_COMPLIANCE_SLICES.md) · [brief MC-0](agent-tasks/DEPUTYTASK_MATERIAL_COMPLIANCE_AI_FOUNDATION.md) · ADR-020…024 |
