...
| **Pivot WPS — generazione da WPQR (non ingest)** | Feedback Mason 30/07/2026: l’ingest batch WPS non risponde al caso d’uso reale («genera WPS da WPQR / segnala estensioni»). Cuore prodotto = matcher 15614 + bozza 15609. **P0** (Tabella 5 + `wpsGenerator` + caso FW S355/S235) in [DEPUTYTASK1.md](agent-tasks/DEPUTYTASK1.md). Ingest WPQR resta centrale; ingest WPS → legacy (P2). | [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) |
...
| **Range di qualificazione automatico WPQR/patentino (Tabelle 7 Level 1 / parti GAP)** | Gap analysis ingest 26/07/2026 ([GUIDA](GUIDA_CONSOLIDATA.md#lezioni-apprese-consolidate-fonte-unica)) | Tabella 8/9 e Tabella 7 Level 2 (bande 3–40 mm) già codificate; **Tabella 5 acciai** in corso in P0 generatore WPS ([DEPUTYTASK1.md](agent-tasks/DEPUTYTASK1.md)). Restano GAP: Tabella 7 Level 1 (cifra iniziale), Tabella 6 nichel | P0 chiude Tabella 5 per matching materiali; Level 1 solo dopo verifica su PDF ufficiale; ingest continua a preferire range **dichiarati** sul documento |
...
- **Pivot WPS (30/07/2026)**: il valore del modulo procedure non è l’ingest PDF WPS, ma la **generazione WPS da WPQR** (caso demo: FW S355 10 mm + S235 5 mm, con segnalazione estensioni mancanti). Spec: [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) · brief P0 [DEPUTYTASK1.md](agent-tasks/DEPUTYTASK1.md)
...
| **Generatore WPS da WPQR (Mason)** | Pivot 30/07/2026: Tabella 5 15614 + `wpsGenerator` (P0) → endpoint/UI (P1) → deprecare ingest WPS come flusso primario (P2). Spec: [MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md](specs/MODULO_WPS_GENERAZIONE_SCOPO_E_ROADMAP.md) | 🟡 Brief P0 APERTO ([DEPUTYTASK1.md](agent-tasks/DEPUTYTASK1.md)) |
