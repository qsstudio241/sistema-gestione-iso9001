...
> **Prossimo Step**: Sessione 07/05 — S-A1÷S-A6 tutti ✅. **Prossime priorità nell'ordine**: (1) Smoke Mason ISO 3834 (passi 6-7 smoke L3); (2) Smoke Word export Camellini audit reale; (3) ISO 14001 checklist completa da norma PDF (P4); (4) SMTP Alert Engine VPS (variabili env).
...
| **S-A6** | **NC audit vs modulo NC** — pulsante "Promuovi al registro NC" (opzione C stub monodirezionale): `POST /audits/:id/promote-nc`, migrazione 049, badge "Promossa ✓", idempotenza via `promoted_local_nc_id` | Deputy (07/05/2026) | ✅ Completato |
