...
| **S-A6** | **Pulizia audit — opzione D** — rimuovere `NonConformitiesManager` dal verbale; metriche/export da **solo checklist**; ponte «Importa da audit» in task modulo `/nc` (vedi `AUDIT_MODULE_LEAD_BRIEF.md §10`) | Deputy — `DEPUTYTASK.md` | ⏳ In corso |
