...
```powershell
cd "C:\ProgettoISO"
scp -P 1122 backend/src/controllers/audit.controller.js backend/src/controllers/sync.controller.js spascarella@busato.selfip.com:/var/www/sgq-backend/src/controllers/
```
