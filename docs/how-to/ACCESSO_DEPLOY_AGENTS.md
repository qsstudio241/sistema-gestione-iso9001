...
| Voce | Valore |
|------|--------|
| **Base API** | `https://busato.selfip.com:8443/api/v1` |
| **Health** | `https://busato.selfip.com:8443/api/v1/health` |
...
ssh-copy-id -i ~/.ssh/id_ed25519_sgq.pub -p 1122 spascarella@busato.selfip.com
