...
| **Ruolo upload ≠ filtro KPI (19/08/2026, MC-I1)** — l’upload Materiali inviava sempre `materialRole: "base"`. Le card Base/Apporto filtrano la griglia; non sono la scelta del PDF nuovo. | Header: radiogroup **Ruolo** (default Base) accanto a Carica, stato `uploadRole` separato dal filtro. Upload Apporto → `filler`. Non hardcodare il ruolo. | PR [#473](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/473) · `MaterialCertificatesPage.jsx` |
