...
|---------|--------------------|-----------|
| **ISO 3834 = processi §5–18, non pagine (15–16/08/2026)** — WPS/WPQR/qualifiche/commesse/RDP ci sono; il gap è ponti + RBAC + report. HITL: niente blocco §5.3; Word RDP Mason; livello 2/3/4 = meno schermate *dopo*, partenza senza filtri; certificati = griglia DDT + anagrafica (epic MC, ingest qualifiche/WPQR + OCR). | Non aprire un CRUD 3834 per i 3.1. Elenco MC = `SgqDataGrid` come Qualifiche, DDT obbligatorio. | [PLAN](agent-tasks/PLAN_3834_SLICES.md) · [PLAN MC](agent-tasks/PLAN_MATERIAL_COMPLIANCE_SLICES.md) · [gap 15/08](gap-reports/GAP_RDP_3834_2026-08-15.md) |
