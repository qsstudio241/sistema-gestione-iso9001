...
**Fase 3 integrazioni audit/NC (02/07/2026)**: `conformity_hint` sincronizzato da ultimo audit completato (`POST .../sync-audit-hints`); azioni Piano Azioni con `source_category='sal_gap'` (mig. 118). Feed Riesame §9.3 resta Fase 4.
