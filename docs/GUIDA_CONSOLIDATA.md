...
| **DNA visivo nel boot agente (13/08/2026)** — stesso principio di `AGENTS.md`: le regole di gusto stanno in un file sempre letto quando si tocca UI, non in una skill esterna. | Passo 5 di `AGENTS.md` (solo se il task tocca JSX/CSS). Fonte: [`app/src/design-system/README.md`](../app/src/design-system/README.md). | Harness · nessuna dipendenza GitHub |
