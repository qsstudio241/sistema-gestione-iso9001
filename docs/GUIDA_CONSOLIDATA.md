...
**Fase 2 export + evidenze (02/07/2026 — completata)**: export Word SAL (`wordExportSal.js`), storico revisioni in modal, evidenze collegate al Registro Documenti (`SalEvidenceSection` + validazione backend su `document_registry`). Feed Riesame §9.3 resta Fase 4.
