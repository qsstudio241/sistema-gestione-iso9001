...
| **ISO-4 Word visita = Quesito/Evidenze/Esito (07/09/2026)** — l’export Audit 3834 riusava le colonne ISO 9001 e anteponeva «Rilievi pendenti». Mason 27/01 è visita a quesiti. | Iniezione checklist `ISO_3834_2`/`RDP_MSN`: intestazioni **Quesito \| Evidenze (eventuali foto) \| Esito** (`STATUS_CFG` C/NC); niente cap. Rilievi pendenti. Scala 1–6 resta ISO-4b. | [`PLAN_3834`](agent-tasks/PLAN_3834_SLICES.md) · `wordExportHelpers.js` · branch `cursor/iso4-word-visita-mason-8269` |
