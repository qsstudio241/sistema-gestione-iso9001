...
|---------|--------------------|-----------|
| **ISO 3834 = processi §5–18, non pagine (15/08/2026)** — WPS/WPQR/qualifiche/commesse/RDP ci sono; il gap è ponti + RBAC + report. Completo = ogni processo ha dati + ponte + prova esportabile. | Non aprire un CRUD nuovo per «finire la 3834». Prima affidabilità (`company_access` su RDP, pattern Commesse), poi HITL §5.3/template RDP, poi ponti NC/offerta. Consumabili/materiali = epic MC, non duplicare. | [PLAN](agent-tasks/PLAN_3834_SLICES.md) · [gap 15/08](gap-reports/GAP_RDP_3834_2026-08-15.md) |
