...
|---------|--------------------|-----------|
| **ISO 3834 = processi §5–18, non pagine (15–16/08/2026)** — WPS/WPQR/qualifiche/commesse/RDP ci sono; il gap è ponti + RBAC + report. HITL: niente blocco commessa su §5.3; Word RDP dal verbale Mason; stessa UI per livello 2/3/4; certificati materiali = epic MC (scan + ingest qualifiche/WPQR + OCR), non un CRUD 3834. | Non aprire un CRUD nuovo per «finire la 3834». Prima affidabilità (`company_access` su RDP). Non inventare un secondo motore OCR/ingest per i 3.1. | [PLAN](agent-tasks/PLAN_3834_SLICES.md) · [PLAN MC](agent-tasks/PLAN_MATERIAL_COMPLIANCE_SLICES.md) · [gap 15/08](gap-reports/GAP_RDP_3834_2026-08-15.md) |
