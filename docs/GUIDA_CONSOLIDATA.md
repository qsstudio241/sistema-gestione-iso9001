...
- **MC-2 (17/08/2026)**: KB Markdown in `knowledge/material-compliance/` (copia deploy `backend/data/material-compliance/`). Loader `materialKbLoader.service.js`: hash SHA-256 dei file, soglie EN 10025-2 da tabelle; tubi e apporto = skip. Niente seed inventato.
