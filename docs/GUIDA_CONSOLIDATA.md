...
| **PR draft ferma da mesi (15/08/2026)** — [PR #10](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/10) (P.IVA/logo tenant, aprile 2026, 180 file) era ancora aperta in roadmap come «da ricostruire». Su `main` la funzione è già in **Il mio Studio** e in **Licenze**. | Prima di rebase/ricostruire una PR vecchia: cercare su `main` route e pagina equivalenti. Se esiste, **chiudere senza merge**. Non tenere priorità aperte su codice morto. | PR #10 **chiusa** 15/08/2026 |
