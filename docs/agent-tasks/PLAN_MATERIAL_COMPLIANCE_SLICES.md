...
**Norme e campi da estrarre:** consegnate 16/08/2026 (EN 10204, EN 10168, ISO 10474, ISO 404, ISO 6929, facsimile MTC). Markdown in `docs/Normative/` NORMA_00020–00025 + KB `knowledge/material-compliance/`. Dizionario campi = EN 10168 (non inventato). **Soglie numeriche di grado** (EN 10025-2, …) ancora assenti: non seedarle. Sintesi: [`MATERIAL-COMPLIANCE-NORME-SINTESI.md`](../reference/MATERIAL-COMPLIANCE-NORME-SINTESI.md). La griglia elenco (DDT + anagrafica) resta valida; i campi lab seguono i codici 10168.
