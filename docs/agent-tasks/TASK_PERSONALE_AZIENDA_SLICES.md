...
**Slice corrente consigliata:** `S6` UI overview (API gi� su `GET /api/v1/personnel`)
...
- Deploy `companyPersonnel.controller.js`, `company.routes.js`; health `https://busato.selfip.com:8443/api/v1/health` OK
