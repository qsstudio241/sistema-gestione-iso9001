...
- **Bridge** verso `notification_contacts` (email/alert NC) ù referenti studio restano rubrica con `company_id` NULL
...
- Rimuovere ùreferente esternoù NC prima di S8+S9
