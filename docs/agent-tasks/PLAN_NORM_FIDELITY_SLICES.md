...
> **Brief attivi (parallelo)**: [`DEPUTYTASK.md`](DEPUTYTASK.md) **NG-3** · [`DEPUTYTASK1.md`](DEPUTYTASK1.md) **CND-2** (file disgiunti)
> **Mappa creata**: 25/08/2026 · **NG-0+NG-1**: 25/08/2026
...
| **NG-3** | Rafforzare skill gap | `.cursor/skills/gap-analysis-normativa/` | NG-1 | AFK | **APERTO** (`DEPUTYTASK.md`) |
...
**Parallelo ora**: NG-3 (docs skill) **e** CND-2 (verbali NDT / gate 9712) su slot diversi — file disgiunti.
...
3. Preferenza NG-2/3 vs NG-4: in corso NG-3 + CND-2 in parallelo
