...
> **Brief attivi**: [`DEPUTYTASK.md`](DEPUTYTASK.md) **CND-7 CHIUSO** (posa registro); [`DEPUTYTASK1.md`](DEPUTYTASK1.md) **CND-6 APERTO**. **CND-3** CHIUSO (#571). **CND-2** CHIUSO (#561). **CND-1** CHIUSO (#549). **CND-4** CHIUSO (#547). **CND-11** CHIUSO (#546).
> **Mappa**: CND-0…CND-4/11 + CND-7 su `main` (o PR). **Ora**: CND-6 (foto/NC mobile). Stream STUD-1 parallelo (WPQR).
...
| **CND-7** | Completa verbale → posa nel registro documenti (`report_ndt` / cartella 9.3) | `ndtReports.controller.js`, pattern posa ingest | CND-4 utile | ✅ 26/08 | [`DEPUTYTASK.md`](DEPUTYTASK.md) CHIUSO; parallelo CND-6 |
...
Ora (26/08, post CND-3 #571 + NG-4 #570):
  CND-7  (posa registro) — CHIUSO su DEPUTYTASK.md
