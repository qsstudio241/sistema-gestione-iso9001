...
> **Brief attivo**: [`DEPUTYTASK2.md`](DEPUTYTASK2.md) — slice **SB-1** (**CHIUSO**, mergiata [PR #440](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/440)). Prossima: SB-2. **Non** usare `DEPUTYTASK.md` (occupato da SAL S1a).
...
- **SB-1 ✅** — `GET /ai/ambito-facts` + card in Assistente AI; zero LLM; isolamento per `company_id`. Brief CHIUSO, mergiata [PR #440](https://github.com/qsstudio241/sistema-gestione-iso9001/pull/440).
