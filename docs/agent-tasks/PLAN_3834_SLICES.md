...
> **Brief**: [DEPUTYTASK1.md](DEPUTYTASK1.md) — slice **ISO-1d** **CHIUSO** (PR #442). Serie ISO-1* RBAC completa dopo merge.
...
**ISO-1a–1d chiuse** (PR #438 / #439 / #441 / #442): isolamento azienda su RDP, NDT, Attrezzature e Welding Book.

## Pronto a eseguire (16/08, dopo ISO-1d)

**Sì, si parte a slice.** Un deputy = una slice. In parallelo solo se i file sono disgiunti.

| Ora | Aspettare |
|-----|-----------|
| **ISO-2** — riesame §5.3 data/utente + Word (dopo merge #442) | — |
...
Dopo merge #442: Lead apre brief ISO-2 in `DEPUTYTASK1.md` (sovrascrive, Stato APERTO) — oppure ISO-3 in parallelo su file disgiunti.  
