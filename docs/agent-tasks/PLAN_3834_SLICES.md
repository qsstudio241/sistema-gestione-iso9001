...
| **ISO-5b** | Allegati foto cordone per riga saldatura + embed Word | `attachments.welding_book_weld_id` + UI riga WB + upsert welds | ISO-5 | In corso (`cursor/iso5b-foto-cordone-8269`) |
