...
| **5** | **Analisi AI unificata su tutti i documenti** | Un pulsante "Analizza documenti commessa" che orchestra testo+vision e popola la tabella requisiti unica | nuovo `caseDocumentAnalysis.service.js` (orchestratore), riuso estrattori | slice 2, 4 | **Alto** (epica) | Molto alto: cuore della visione |
| **6** | **Pre-compilazione checklist §8.2** | I requisiti confermati suggeriscono risposte/note su P1-P10 e F1-F6 (con origine AI tracciata) | `contractReview.controller.js`, UI checklist | slice 5 | Medio | Alto: chiude il ciclo offerta→riesame |
| **7** | **Match requisiti ↔ qualifiche/WPS** | I requisiti disegno (materiale/spessore/processo/posizioni) alimentano `computeQualificationCoverage` e mostrano semaforo copertura nel caso | `qualificationCoverage.js` (riuso), nuovo collante | slice 5 | Medio | Alto: riesame tecnico ISO 3834 |
