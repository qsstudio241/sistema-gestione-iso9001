...
-- default_expiry_months: mesi di validit� default al rilascio (se expiry_date vuota)
-- ============================================================================
...
END
ELSE
    PRINT '  Colonna next_number gi� presente';
GO
...
END
ELSE
    PRINT '  Colonna default_expiry_months gi� presente';
GO
...
END
ELSE
    PRINT '  Colonna updated_at gi� presente';
GO
