/**
 * seed-system-tags.js — Crea tag e categorie di sistema per il Document Registry
 *
 * Eseguire sul VPS dopo le migration 056+:
 *   node /tmp/seed-system-tags.js
 *
...
const dbConfig = (() => {
  try {
    return require('/var/www/sgq-backend/src/config/database');
  } catch {
...
async function main() {
  ...
  console.log('Connesso al DB. Inizio seed tag di sistema...');
