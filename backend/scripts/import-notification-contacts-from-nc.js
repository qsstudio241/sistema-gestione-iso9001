 ...
 *
 * Per ogni valore testo non vuoto SENZA contact_id gi� valorizzato:
 *   - crea riga in notification_contacts (email dedotta dal testo o placeholder)
 *   - se stesso nome esiste gi� nell'org (case-insensitive) riusa l'id
 ...
 *   scp -P 1122 backend/scripts/import-notification-contacts-from-nc.js spascarella@busato.selfip.com:/tmp/
 *   ssh -p 1122 spascarella@busato.selfip.com "node /tmp/import-notification-contacts-from-nc.js --dry-run"
 *   ssh -p 1122 spascarella@busato.selfip.com "node /tmp/import-notification-contacts-from-nc.js"
 *
