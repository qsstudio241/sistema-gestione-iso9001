/**
 * Migration 116 (VPS) — Persistenza analisi capitolato sul caso commerciale.
 ...
 * Uso sul VPS:
 *   .\backend\scripts\run-on-vps.ps1 -Script backend\scripts\run-migration-116-vps.js
 */
...
async function run() {
    ...
    try {
        ...
        `);
        console.log('[116] (1) colonna source OK');
        ...
        `);
        console.log('[116] (2) CHECK source OK');
        ...
        `);
        console.log('[116] (3) drop CHECK req_type OK');
        ...
        `);
        console.log('[116] (4) CHECK req_type esteso OK');
        ...
        `);
        console.log('[116] (5) indice OK');
        console.log('[116] Migration completata.');
    } catch (e) {
        console.error('[116] ERRORE:', e.message);
        process.exit(1);
    } finally {
