 ...
 *
 * Da Cloud Agent:
 *   scp -i /tmp/sgq_key -P 1122 backend/scripts/run-migration-101-vps.js spascarella@busato.selfip.com:/tmp/
 *   ssh -i /tmp/sgq_key -p 1122 spascarella@busato.selfip.com "node /tmp/run-migration-101-vps.js"
 */
