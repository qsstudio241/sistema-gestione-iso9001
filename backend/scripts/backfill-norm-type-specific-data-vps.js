 ...
 *
 * Uso VPS:
 *   scp -P 1122 backend/scripts/backfill-norm-type-specific-data-vps.js spascarella@sistemi.fr-busato.it:/tmp/
 *   ssh -p 1122 spascarella@sistemi.fr-busato.it "node /tmp/backfill-norm-type-specific-data-vps.js"
 */
