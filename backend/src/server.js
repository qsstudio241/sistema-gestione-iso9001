...
const commercialChecklistTemplateRoutes = require('./routes/commercialChecklistTemplate.routes');
...
const librarySourceRequestRoutes = require('./routes/librarySourceRequest.routes');
...
const rdpRoutes              = require('./routes/rdp.routes');
const materialCertificatesRoutes = require('./routes/materialCertificates.routes');
const complianceMapRoutes = require('./routes/complianceMap.routes');
...
app.use(API_BASE, commercialChecklistTemplateRoutes);
...
app.use(API_BASE, rdpRoutes);
app.use(API_BASE, materialCertificatesRoutes);
app.use(API_BASE, complianceMapRoutes);
...
function startServer() {
    if (process.env.SSL_ENABLED === 'true') {
        ...
        httpsServer.listen(PORT, () => {
            logger.info(`🔒 HTTPS Server running on https://sistemi.fr-busato.it:${PORT}`);
        });
    } else {
