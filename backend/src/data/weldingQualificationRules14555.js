 ...
 * Mantenere sincronizzato con app/src/data/weldingQualificationRules14555.js
 *
...
const BOILER_PIN_BEND_MOMENTS_NM = Object.freeze({
  8: 40,
  10: 60,
  12: 85,
});
 ...
 * @returns {boolean}
 */
function isIso14555(standardReference) {
 ...
 */
function describeQualifiedStudSectionRange({ testSectionsMm } = {}) {
 ...
 */
function describeQualifiedParentThicknessRange14555({ pWpsApplies = true } = {}) {
 ...
 */
function describeQualifiedPositions14555({
  weldingTimeMs,
  testPosition,
  throughDeck = false,
} = {}) {
 ...
 */
function isPositionCovered14555({
  weldingTimeMs,
  testPosition,
  productionPosition,
  throughDeck = false,
 ...
 * @returns {boolean}
 */
function isBathProtectionCovered14555({
  qualifiedMethod,
  productionMethod,
} = {}) {
 ...
 */
function isSimilarMaterialsCovered14555({
  parentGroup,
  studGroup,
  studDiameterMm,
  weldingTimeMs,
 ...
 */
function isDissimilarMaterialsCovered14555({
  parentGroup,
  studGroup,
  weldingTimeMs,
} = {}) {
 ...
 * @returns {boolean}
 */
function isThroughDeckSheetThickness({ sheetThicknessMm } = {}) {
 ...
 */
function isThroughDeckSheetCovered14555({
 ...
 * @returns {number|null}
 */
function getBoilerPinMinimumBendMomentNm(diameterMm) {
 ...
 * }}
 */
function evaluateBoilerPinBendAcceptance({
  diameterMm,
  measuredMomentNm,
  clause123Ok = false,
