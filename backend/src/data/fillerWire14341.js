...
const EXAMPLE_COMPOSITION_SYMBOLS = ['3Si1', '4Si1', 'S3', 'S11', 'Z4Mo1'];

/**
 * Sezione prompt AI per WPS/WPQR (campo filler_material).
 * @returns {string}
 */
function buildFillerWire14341PromptSection() {
  return `
