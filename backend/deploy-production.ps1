...
# CORS
CORS_ORIGIN=https://systemgest.netlify.app,https://busato.selfip.com
...
# SSL/TLS
SSL_ENABLED=true
SSL_KEY_PATH=C:\Certbot\live\busato.selfip.com\privkey.pem
SSL_CERT_PATH=C:\Certbot\live\busato.selfip.com\fullchain.pem
...
Write-Host "3. Testa: Invoke-WebRequest https://busato.selfip.com:10443/health" -ForegroundColor White
Write-Host ""
