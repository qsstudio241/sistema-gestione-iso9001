...
/**
 * @type {Array<{ code: string, labelIt: string, labelEn: string, product: 'plate'|'pipe'|'both', aliases: string[] }>}
 */
...
/** Match lunghi prima (H-L045 prima di PA). */
...
/**
 * @param {{ includeAltro?: boolean, product?: 'plate'|'pipe'|'both' }} [opts]
