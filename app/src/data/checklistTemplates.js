    ...
    },
    {
      ...
      questions: [
        { questionId: 194, clauseRef: "8.1",   questionText: "Pianificazione e controllo operativi", questionType: "conformity", isMandatory: true, displayOrder: 39 },
         ...
         { questionId: 200, clauseRef: "8.3.1", questionText: "8.3.1 — Progettazione e sviluppo: Generalità", questionType: "conformity", isMandatory: true, displayOrder: 45 },
         { questionId: 201, clauseRef: "8.3.2", questionText: "8.3.2 — Pianificazione della progettazione e sviluppo", questionType: "conformity", isMandatory: true, displayOrder: 46 },
         { questionId: 202, clauseRef: "8.3.3", questionText: "8.3.3 — Input alla progettazione e sviluppo", questionType: "conformity", isMandatory: true, displayOrder: 47 },
         { questionId: 203, clauseRef: "8.3.4", questionText: "8.3.4 — Controlli della progettazione e sviluppo", questionType: "conformity", isMandatory: true, displayOrder: 48 },
         { questionId: 204, clauseRef: "8.3.5", questionText: "8.3.5 — Output della progettazione e sviluppo", questionType: "conformity", isMandatory: true, displayOrder: 49 },
         { questionId: 205, clauseRef: "8.3.6", questionText: "8.3.6 — Modifiche della progettazione e sviluppo", questionType: "conformity", isMandatory: true, displayOrder: 50 },
...
/**
 * Registro degli obblighi legali per salute e sicurezza sul lavoro.
 * Fonte: Matrice 14001-45001 Grantini, pagine estratte 24-41 (righe 2991-4416).
 *
 * La fonte disponibile non contiene sotto-domande a/b/c verificabili nella sezione
 * sicurezza: le sezioni mantengono quindi questions vuoto, senza generare quesiti.
 */
export const ISO_45001_LEGISLATIVO_TEMPLATE = {
  standardId: 3,
  standardCode: "LEG_SICUREZZA_81",
  standardName: "Conformità legislativa sicurezza",
  sections: [
    {
      sectionCode: "leg_sic_01",
      sectionTitle: "1. DATORE DI LAVORO, DELEGA DI FUNZIONI, DIRIGENTI E PREPOSTI",
      displayOrder: 1,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Articolo 16 (Delega di funzioni)",
    ...
    {
      sectionCode: "leg_sic_02",
      sectionTitle: "2. SERVIZIO PREVENZIONE E PROTEZIONE (RSPP, ASPP) E RLS",
      displayOrder: 2,
      referenceText: [
        "Accordo 7 luglio 2016 sui percorsi formativi per RSPP",
    ...
    {
      sectionCode: "leg_sic_03",
      sectionTitle: "3. LAVORATORI",
      displayOrder: 3,
      referenceText: null,
      questions: [],
    },
    {
      sectionCode: "leg_sic_04",
      sectionTitle: "4. MEDICO COMPETENTE E SORVEGLIANZA SANITARIA",
      displayOrder: 4,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Articolo 18, comma 1 (nomina)",
    ...
    {
      sectionCode: "leg_sic_05",
      sectionTitle: "5. FORMAZIONE, INFORMAZIONE E ADDESTRAMENTO DEI LAVORATORI",
      displayOrder: 5,
      referenceText: [
    ...
    {
      sectionCode: "leg_sic_06",
      sectionTitle: "6. GESTIONE DEGLI INFORTUNI",
      displayOrder: 6,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Articolo 53, comma 6",
    ...
    {
      sectionCode: "leg_sic_07",
      sectionTitle: "7. RIUNIONE PERIODICA",
      displayOrder: 7,
    ...
    {
      sectionCode: "leg_sic_08",
      sectionTitle: "8. VALUTAZIONE GENERALE DEI RISCHI LAVORATIVI",
      displayOrder: 8,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Articoli 2, 15, 28 e 29",
    ...
    {
      sectionCode: "leg_sic_09",
      sectionTitle: "9. RISCHI AGENTI BIOLOGICI",
      displayOrder: 9,
      referenceText: [
        "Accordo 7 febbraio 2013 sulla valutazione e gestione dei rischi correlati all'igiene degli impianti di trattamento aria",
    ...
    {
      sectionCode: "leg_sic_10",
      sectionTitle: "10. RISCHI MOVIMENTAZIONE MANUALE DEI CARICHI",
      displayOrder: 10,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Movimentazione manuale dei carichi (articoli 167-171)",
    ...
    {
      sectionCode: "leg_sic_11",
      sectionTitle: "11. RISCHI TRAINO/SPINTA, TRASPORTO IN PIANO",
      displayOrder: 11,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Movimentazione manuale dei carichi (articoli 167-171)",
        "D.Lgs. 81/2008 e s.m.i. - Allegato XXXIII",
    ...
    {
      sectionCode: "leg_sic_12",
      sectionTitle: "12. POSTURE INCONGRUE",
      displayOrder: 12,
      referenceText: [
    ...
    {
      sectionCode: "leg_sic_13",
      sectionTitle: "13. RISCHI MOVIMENTI RIPETITIVI CON SOVRACCARICO ARTI SUPERIORI",
      displayOrder: 13,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i.",
        "Movimentazione manuale dei carichi (articoli 167-171)",
    ...
    {
      sectionCode: "leg_sic_14",
      sectionTitle: "14. ATTREZZATURE MUNITE DI VIDEOTERMINALI",
      displayOrder: 14,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Titolo VII, attrezzature munite di videoterminali (articoli 172-179)",
    ...
    {
      sectionCode: "leg_sic_15",
      sectionTitle: "15. RISCHIO ATMOSFERE ESPLOSIVE",
      displayOrder: 15,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Titolo XI",
    ...
    {
      sectionCode: "leg_sic_16",
      sectionTitle: "16. RISCHIO ELETTRICO, ELETTROSTATICO, FULMINAZIONE",
      displayOrder: 16,
      referenceText: [
    ...
    {
      sectionCode: "leg_sic_17",
      sectionTitle: "17. RISCHIO STRESS LAVORO CORRELATO",
      displayOrder: 17,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i.",
    ...
    {
      sectionCode: "leg_sic_18",
      sectionTitle: "18. RISCHIO LAVORATRICI IN STATO DI GRAVIDANZA",
      displayOrder: 18,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i.",
        "D.Lgs. 26 marzo 2001, n. 151",
    ...
    {
      sectionCode: "leg_sic_19",
      sectionTitle: "19. RISCHIO LAVORO NOTTURNO",
      displayOrder: 19,
      referenceText: "D.Lgs. 81/2008 e s.m.i.",
      questions: [],
    },
    {
      sectionCode: "leg_sic_20",
      sectionTitle: "20. RISCHIO LUOGHI ELEVATI CON PERICOLO DI CADUTA",
      displayOrder: 20,
      referenceText: "D.Lgs. 81/2008 e s.m.i.",
      questions: [],
    },
    {
      sectionCode: "leg_sic_21",
      sectionTitle: "21. LUOGHI DI LAVORO",
      displayOrder: 21,
      referenceText: [
        "D.M. 22 gennaio 2019 sulla segnaletica stradale destinata alle attività lavorative in presenza di traffico veicolare",
    ...
    {
      sectionCode: "leg_sic_22",
      sectionTitle: "22. APPROVVIGIONAMENTO ACQUA CONSUMO UMANO",
      displayOrder: 22,
      referenceText: [
    ...
    {
      sectionCode: "leg_sic_23",
      sectionTitle: "23. MACCHINE / ATTREZZATURE DI LAVORO",
      displayOrder: 23,
      referenceText: [
        "Regolamento (UE) 2023/1230, applicabile dal 20 gennaio 2027",
    ...
    {
      sectionCode: "leg_sic_24",
      sectionTitle: "24. MEZZI DI SOLLEVAMENTO",
      displayOrder: 24,
      referenceText: [
        "D.Lgs. 81/2008 e s.m.i. - Allegati VI e VII",
    ...
    {
      sectionCode: "leg_sic_25",
      sectionTitle: "25. APPARECCHI A PRESSIONE",
      displayOrder: 25,
      referenceText: [
    ...
    {
      sectionCode: "leg_sic_26",
      sectionTitle: "26. CANTIERI TEMPORANEI E MOBILI",
      displayOrder: 26,
      referenceText: [
    ...
    {
      sectionCode: "leg_sic_27",
      sectionTitle: "27. DPI E RELATIVA GESTIONE",
      displayOrder: 27,
      referenceText: [
        "D.Lgs. 19 febbraio 2019, n. 17 - Adeguamento al Regolamento (UE) 2016/425 sui dispositivi di protezione individuale",
        "D.Lgs. 81/2008 e s.m.i.",
      ].join("\n"),
      questions: [],
    },
    {
      sectionCode: "leg_sic_28",
      sectionTitle: "28. AMBITI NORMATI DIVERSAMENTE (NON APPLICABILE IL TESTO UNICO)",
      displayOrder: 28,
      referenceText: [
        "D.Lgs. 14 maggio 2019, n. 50 - Sicurezza delle ferrovie",
