    ...
    const doc = new Document({
        ...
        sections: [{
            ...
            children: [
                ...
                sectionTitle('3. Analisi delle cause'),
                bodyBlock('{rootCause}'),
                sectionTitle('4. Azioni correttive'),
                para('{#noActions}Nessuna azione registrata.{/noActions}', { after: 120 }),
