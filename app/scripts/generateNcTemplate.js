    ...
    const doc = new Document({
        ...
        sections: [{
            ...
            children: [
                ...
                sectionTitle('3. Trattamento - correzione (ISO 10.2.1a)'),
                ...
                sectionTitle('4. Verifica attuazione trattamento'),
                bodyBlock('{verificationNotes}'),
                para('Responsabile verifica: {verificationResponsible}', { after: 120 }),
                sectionTitle('5. Valutazione azione correttiva (ISO 10.2.1b)'),
                ...
                sectionTitle('6. Analisi delle cause'),
                bodyBlock('{rootCause}'),
                sectionTitle('7. Azioni correttive / preventive'),
                ...
                sectionTitle('8. Verifica efficacia azione correttiva (ISO 10.2.1e)'),
                bodyBlock('{effectivenessVerificationNotes}'),
                sectionTitle('9. Chiusura e approvazione'),
                para('Approvata da: {approvedByName}', { after: 60 }),
                para('Approvata il: {approvedAt}', { after: 120 }),
                sectionTitle('10. Evidenze allegate'),
