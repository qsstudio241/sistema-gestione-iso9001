...
| `Normative NORMA_00043_ BS EN ISO 15614-1_2017_A1_2019 Rev. 0.md` (+ `.json`) | — (non seed SGQ) | ISO 15614-1:2017+A1:2019 | WPQR / range — estratto `docs/reference/ISO-15614-1-range-validita-WPQR.md`; archivio senza A1 = `NORMA_00019` |
